...
|---|---|---|---|---|---|---|---|
| jev | 6/6 | 2/16 | 0 | – | 0 | 297 / 677 ms | $0.0013 |
| haiku | 6/6 | 16/16 | 22 | 21/22 | 23 | 1751 / 3343 ms | $0.0634 |
| haiku+jev | 6/6 | 16/16 | 22 | 21/22 | 23 | 2091 / 5156 ms | $0.0658 |
| routed | 6/6 | 16/16 | 17 | 16/17 | 18 | 1745 / 5156 ms | $0.0511 |

| Case | Start | Expected | Jev | Render | Confidence |
|---|---|---|---|---|---|
| b01 undo | bars | undo | undo | chart | 0.89 |
| b02 undo that | map | undo | undo | chart | 0.87 |
| b03 go back | pie | undo | undo | chart | 0.87 |
| b04 that was wrong, revert it | map | undo | undo | chart | 0.89 |
| b05 maak dat ongedaan | bars | undo | undo | chart | 0.90 |
| b06 terug naar hoe het was | line | undo | undo | chart | 0.59 |
...
| b10 reset the zoom | map | zoom | zoom/all | chart | 0.83 |
...
| b13 go back to the bar chart | line | mark | mark/bars | chart | 0.88 |
| r01 show the rows as a table | bars | no_change, table | **✗** mark/keep | table | 0.82 |
| r02 export this to parquet | map | no_change, export | no_change | export | 0.62 |
| r03 show the ground points as a table | bars | transform, table | **✗** mark/bars | table | 0.74 |
| r04 exclude building | pie | transform, chart | transform | chart | 1.00 |
| r05 make the bars red | bars | color, chart | color/red | chart | 1.00 |
| o01 what data is there? | bars | no_change, overview | **✗** no_change | chart | 0.68 |
| o02 welke kolommen heeft de tile? | map | no_change, overview | no_change | overview | 0.21 |
| o03 I don't know what I can do with this data, show me what's in it | pie | no_change, overview | **✗** mark/bars | overview | 0.62 |

Jev only: 17/21 right.
